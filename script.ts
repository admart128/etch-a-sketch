...
let currentColorValue: string = "🎨#000000"
let mouseIsClicked: boolean = false
...
function renderNewColor() {
    ...
    const currentColorSampleElement = document.getElementById('currentColorSample') as HTMLTableElement;
    ...
    const currentColorValueElement = document.getElementById('currentColorValue') as HTMLDivElement;
